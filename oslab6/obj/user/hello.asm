...
00800248 <vprintfmt>:
{
  ...
  800294:	ff 24 85 60 11 80 00 	jmp    *0x801160(,%eax,4)
  ...
  80035b:	83 f8 0f             	cmp    $0xf,%eax
  80035e:	7f 23                	jg     800383 <vprintfmt+0x13b>
  800360:	8b 14 85 c0 12 80 00 	mov    0x8012c0(,%eax,4),%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800b14:	68 1f 13 80 00       	push   $0x80131f
  800b19:	6a 23                	push   $0x23
  800b1b:	68 3c 13 80 00       	push   $0x80133c
  800b20:	e8 2f 02 00 00       	call   800d54 <_panic>
...
sys_yield(void)
{
  ...
  800b4f:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b95:	68 1f 13 80 00       	push   $0x80131f
  800b9a:	6a 23                	push   $0x23
  800b9c:	68 3c 13 80 00       	push   $0x80133c
  800ba1:	e8 ae 01 00 00       	call   800d54 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bd7:	68 1f 13 80 00       	push   $0x80131f
  800bdc:	6a 23                	push   $0x23
  800bde:	68 3c 13 80 00       	push   $0x80133c
  800be3:	e8 6c 01 00 00       	call   800d54 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c19:	68 1f 13 80 00       	push   $0x80131f
  800c1e:	6a 23                	push   $0x23
  800c20:	68 3c 13 80 00       	push   $0x80133c
  800c25:	e8 2a 01 00 00       	call   800d54 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c5b:	68 1f 13 80 00       	push   $0x80131f
  800c60:	6a 23                	push   $0x23
  800c62:	68 3c 13 80 00       	push   $0x80133c
  800c67:	e8 e8 00 00 00       	call   800d54 <_panic>

00800c6c <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c8d:	7f 08                	jg     800c97 <sys_env_set_trapframe+0x2b>
  ...
  800c9d:	68 1f 13 80 00       	push   $0x80131f
  800ca2:	6a 23                	push   $0x23
  800ca4:	68 3c 13 80 00       	push   $0x80133c
  800ca9:	e8 a6 00 00 00       	call   800d54 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ccf:	7f 08                	jg     800cd9 <sys_env_set_pgfault_upcall+0x2b>
  ...
  800cdf:	68 1f 13 80 00       	push   $0x80131f
  800ce4:	6a 23                	push   $0x23
  800ce6:	68 3c 13 80 00       	push   $0x80133c
  800ceb:	e8 64 00 00 00       	call   800d54 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d33:	7f 08                	jg     800d3d <sys_ipc_recv+0x2a>
  ...
  800d43:	68 1f 13 80 00       	push   $0x80131f
  800d48:	6a 23                	push   $0x23
  800d4a:	68 3c 13 80 00       	push   $0x80133c
  800d4f:	e8 00 00 00 00       	call   800d54 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d58:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800d59:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800d5c:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800d62:	e8 be fd ff ff       	call   800b25 <sys_getenvid>
  800d67:	83 ec 0c             	sub    $0xc,%esp
  800d6a:	ff 75 0c             	pushl  0xc(%ebp)
  800d6d:	ff 75 08             	pushl  0x8(%ebp)
  800d70:	56                   	push   %esi
  800d71:	50                   	push   %eax
  800d72:	68 4c 13 80 00       	push   $0x80134c
  800d77:	e8 cf f3 ff ff       	call   80014b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800d7c:	83 c4 18             	add    $0x18,%esp
  800d7f:	53                   	push   %ebx
  800d80:	ff 75 10             	pushl  0x10(%ebp)
  800d83:	e8 72 f3 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  800d88:	c7 04 24 ec 0f 80 00 	movl   $0x800fec,(%esp)
  800d8f:	e8 b7 f3 ff ff       	call   80014b <cprintf>
  800d94:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800d97:	cc                   	int3   
  800d98:	eb fd                	jmp    800d97 <_panic+0x43>
