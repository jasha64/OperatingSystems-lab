...
umain(int argc, char **argv)
{
  ...
  8004d3:	e8 43 0e 00 00       	call   80131b <set_pgfault_handler>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8007bb:	0f be 80 23 17 80 00 	movsbl 0x801723(%eax),%eax
  8007c2:	50                   	push   %eax
...
0080080f <vprintfmt>:
{
  ...
  80085b:	ff 24 85 60 18 80 00 	jmp    *0x801860(,%eax,4)
  ...
  800922:	83 f8 0f             	cmp    $0xf,%eax
  800925:	7f 23                	jg     80094a <vprintfmt+0x13b>
  800927:	8b 14 85 c0 19 80 00 	mov    0x8019c0(,%eax,4),%edx
  80092e:	85 d2                	test   %edx,%edx
  800930:	74 18                	je     80094a <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  800932:	52                   	push   %edx
  800933:	68 44 17 80 00       	push   $0x801744
  800938:	53                   	push   %ebx
  800939:	56                   	push   %esi
  ...
  80094a:	50                   	push   %eax
  80094b:	68 3b 17 80 00       	push   $0x80173b
  800950:	53                   	push   %ebx
  800951:	56                   	push   %esi
  ...
  800972:	b8 34 17 80 00       	mov    $0x801734,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  8010db:	68 1f 1a 80 00       	push   $0x801a1f
  8010e0:	6a 23                	push   $0x23
  8010e2:	68 3c 1a 80 00       	push   $0x801a3c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80115c:	68 1f 1a 80 00       	push   $0x801a1f
  801161:	6a 23                	push   $0x23
  801163:	68 3c 1a 80 00       	push   $0x801a3c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80119e:	68 1f 1a 80 00       	push   $0x801a1f
  8011a3:	6a 23                	push   $0x23
  8011a5:	68 3c 1a 80 00       	push   $0x801a3c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8011e0:	68 1f 1a 80 00       	push   $0x801a1f
  8011e5:	6a 23                	push   $0x23
  8011e7:	68 3c 1a 80 00       	push   $0x801a3c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  801222:	68 1f 1a 80 00       	push   $0x801a1f
  801227:	6a 23                	push   $0x23
  801229:	68 3c 1a 80 00       	push   $0x801a3c
  80122e:	e8 04 f4 ff ff       	call   800637 <_panic>

00801233 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  801254:	7f 08                	jg     80125e <sys_env_set_trapframe+0x2b>
  ...
  801264:	68 1f 1a 80 00       	push   $0x801a1f
  801269:	6a 23                	push   $0x23
  80126b:	68 3c 1a 80 00       	push   $0x801a3c
  801270:	e8 c2 f3 ff ff       	call   800637 <_panic>

00801275 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  801289:	b8 0a 00 00 00       	mov    $0xa,%eax
  80128e:	89 df                	mov    %ebx,%edi
  801290:	89 de                	mov    %ebx,%esi
  801292:	cd 30                	int    $0x30
	if(check && ret > 0)
  801294:	85 c0                	test   %eax,%eax
  801296:	7f 08                	jg     8012a0 <sys_env_set_pgfault_upcall+0x2b>
  ...
  8012a3:	50                   	push   %eax
  8012a4:	6a 0a                	push   $0xa
  8012a6:	68 1f 1a 80 00       	push   $0x801a1f
  8012ab:	6a 23                	push   $0x23
  8012ad:	68 3c 1a 80 00       	push   $0x801a3c
  8012b2:	e8 80 f3 ff ff       	call   800637 <_panic>

008012b7 <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8012c3:	b8 0c 00 00 00       	mov    $0xc,%eax
  8012c8:	be 00 00 00 00       	mov    $0x0,%esi
  8012cd:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8012d0:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  8012eb:	b8 0d 00 00 00       	mov    $0xd,%eax
  8012f0:	89 cb                	mov    %ecx,%ebx
  8012f2:	89 cf                	mov    %ecx,%edi
  8012f4:	89 ce                	mov    %ecx,%esi
  8012f6:	cd 30                	int    $0x30
	if(check && ret > 0)
  8012f8:	85 c0                	test   %eax,%eax
  8012fa:	7f 08                	jg     801304 <sys_ipc_recv+0x2a>
  ...
  801307:	50                   	push   %eax
  801308:	6a 0d                	push   $0xd
  80130a:	68 1f 1a 80 00       	push   $0x801a1f
  80130f:	6a 23                	push   $0x23
  801311:	68 3c 1a 80 00       	push   $0x801a3c
  801316:	e8 1c f3 ff ff       	call   800637 <_panic>

0080131b <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801321:	83 3d d0 20 80 00 00 	cmpl   $0x0,0x8020d0
  801328:	74 0a                	je     801334 <set_pgfault_handler+0x19>
		}
  ...
  80132d:	a3 d0 20 80 00       	mov    %eax,0x8020d0
}
  801332:	c9                   	leave  
  801333:	c3                   	ret    
  ...
  801339:	68 00 f0 bf ee       	push   $0xeebff000
  80133e:	6a 00                	push   $0x0
  801340:	e8 e5 fd ff ff       	call   80112a <sys_page_alloc>
		if (r < 0) {
  801345:	83 c4 10             	add    $0x10,%esp
  801348:	85 c0                	test   %eax,%eax
  80134a:	78 14                	js     801360 <set_pgfault_handler+0x45>
		sys_env_set_pgfault_upcall(0, _pgfault_upcall);		//系统调用，设置进程的env_pgfault_upcall属性
  80134c:	83 ec 08             	sub    $0x8,%esp
  80134f:	68 74 13 80 00       	push   $0x801374
  801354:	6a 00                	push   $0x0
  801356:	e8 1a ff ff ff       	call   801275 <sys_env_set_pgfault_upcall>
  80135b:	83 c4 10             	add    $0x10,%esp
  80135e:	eb ca                	jmp    80132a <set_pgfault_handler+0xf>
			panic("set_pgfault_handler:sys_page_alloc failed");;
  801360:	83 ec 04             	sub    $0x4,%esp
  801363:	68 4c 1a 80 00       	push   $0x801a4c
  801368:	6a 22                	push   $0x22
  80136a:	68 78 1a 80 00       	push   $0x801a78
  80136f:	e8 c3 f2 ff ff       	call   800637 <_panic>

00801374 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  801375:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax				//调用页处理函数
  ...
  801382:	8b 44 24 28          	mov    0x28(%esp),%eax
	movl 32(%esp), %ecx 	//保存终端发生时的eip到ecx
  801386:	8b 4c 24 20          	mov    0x20(%esp),%ecx
	movl %ecx, -4(%eax) 	//将中断发生时的esp值亚入到到原来的栈中
  80138a:	89 48 fc             	mov    %ecx,-0x4(%eax)
	popal
  80138d:	61                   	popa   
	addl $4, %esp			//跳过eip
  ...
  801393:	8d 64 24 fc          	lea    -0x4(%esp),%esp
  801397:	c3                   	ret    
