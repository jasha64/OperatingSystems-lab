...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(faultio) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 c6 23 80 00       	push   $0x8023c6
  80006f:	6a 09                	push   $0x9
  800071:	68 e0 23 80 00       	push   $0x8023e0
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000ef:	56                   	push   %esi
  8000f0:	50                   	push   %eax
  8000f1:	68 00 24 80 00       	push   $0x802400
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800257:	0f be 80 23 24 80 00 	movsbl 0x802423(%eax),%eax
  80025e:	50                   	push   %eax
...
008002ab <vprintfmt>:
{
  ...
  8003e6:	50                   	push   %eax
  8003e7:	68 3b 24 80 00       	push   $0x80243b
  8003ec:	53                   	push   %ebx
  8003ed:	56                   	push   %esi
  ...
  80040e:	b8 34 24 80 00       	mov    $0x802434,%eax
