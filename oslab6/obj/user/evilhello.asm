...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 ea 0f 80 00       	push   $0x800fea
  800114:	6a 23                	push   $0x23
  800116:	68 07 10 80 00       	push   $0x801007
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 ea 0f 80 00       	push   $0x800fea
  800195:	6a 23                	push   $0x23
  800197:	68 07 10 80 00       	push   $0x801007
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 ea 0f 80 00       	push   $0x800fea
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 07 10 80 00       	push   $0x801007
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 ea 0f 80 00       	push   $0x800fea
  800219:	6a 23                	push   $0x23
  80021b:	68 07 10 80 00       	push   $0x801007
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 ea 0f 80 00       	push   $0x800fea
  80025b:	6a 23                	push   $0x23
  80025d:	68 07 10 80 00       	push   $0x801007
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 ea 0f 80 00       	push   $0x800fea
  80029d:	6a 23                	push   $0x23
  80029f:	68 07 10 80 00       	push   $0x801007
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 ea 0f 80 00       	push   $0x800fea
  8002df:	6a 23                	push   $0x23
  8002e1:	68 07 10 80 00       	push   $0x801007
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 ea 0f 80 00       	push   $0x800fea
  800343:	6a 23                	push   $0x23
  800345:	68 07 10 80 00       	push   $0x801007
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80036b:	56                   	push   %esi
  80036c:	50                   	push   %eax
  80036d:	68 18 10 80 00       	push   $0x801018
  ...
  80037e:	e8 56 00 00 00       	call   8003d9 <vcprintf>
	cprintf("\n");
  800383:	c7 04 24 3b 10 80 00 	movl   $0x80103b,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004d3:	0f be 80 3d 10 80 00 	movsbl 0x80103d(%eax),%eax
  8004da:	50                   	push   %eax
...
00800527 <vprintfmt>:
{
  ...
  80064a:	52                   	push   %edx
  80064b:	68 5e 10 80 00       	push   $0x80105e
  800650:	53                   	push   %ebx
  800651:	56                   	push   %esi
  ...
  800662:	50                   	push   %eax
  800663:	68 55 10 80 00       	push   $0x801055
  800668:	53                   	push   %ebx
  800669:	56                   	push   %esi
  ...
  80068a:	b8 4e 10 80 00       	mov    $0x80104e,%eax
