...
00800284 <vprintfmt>:
{
  ...
  8002d0:	ff 24 85 e0 11 80 00 	jmp    *0x8011e0(,%eax,4)
  ...
  800397:	83 f8 0f             	cmp    $0xf,%eax
  80039a:	7f 23                	jg     8003bf <vprintfmt+0x13b>
  80039c:	8b 14 85 40 13 80 00 	mov    0x801340(,%eax,4),%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800b50:	68 9f 13 80 00       	push   $0x80139f
  800b55:	6a 23                	push   $0x23
  800b57:	68 bc 13 80 00       	push   $0x8013bc
  800b5c:	e8 2f 02 00 00       	call   800d90 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd1:	68 9f 13 80 00       	push   $0x80139f
  800bd6:	6a 23                	push   $0x23
  800bd8:	68 bc 13 80 00       	push   $0x8013bc
  800bdd:	e8 ae 01 00 00       	call   800d90 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c13:	68 9f 13 80 00       	push   $0x80139f
  800c18:	6a 23                	push   $0x23
  800c1a:	68 bc 13 80 00       	push   $0x8013bc
  800c1f:	e8 6c 01 00 00       	call   800d90 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c55:	68 9f 13 80 00       	push   $0x80139f
  800c5a:	6a 23                	push   $0x23
  800c5c:	68 bc 13 80 00       	push   $0x8013bc
  800c61:	e8 2a 01 00 00       	call   800d90 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c97:	68 9f 13 80 00       	push   $0x80139f
  800c9c:	6a 23                	push   $0x23
  800c9e:	68 bc 13 80 00       	push   $0x8013bc
  800ca3:	e8 e8 00 00 00       	call   800d90 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cc9:	7f 08                	jg     800cd3 <sys_env_set_trapframe+0x2b>
  ...
  800cd9:	68 9f 13 80 00       	push   $0x80139f
  800cde:	6a 23                	push   $0x23
  800ce0:	68 bc 13 80 00       	push   $0x8013bc
  800ce5:	e8 a6 00 00 00       	call   800d90 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d0b:	7f 08                	jg     800d15 <sys_env_set_pgfault_upcall+0x2b>
  ...
  800d1b:	68 9f 13 80 00       	push   $0x80139f
  800d20:	6a 23                	push   $0x23
  800d22:	68 bc 13 80 00       	push   $0x8013bc
  800d27:	e8 64 00 00 00       	call   800d90 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800d38:	b8 0c 00 00 00       	mov    $0xc,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800d6f:	7f 08                	jg     800d79 <sys_ipc_recv+0x2a>
  ...
  800d7f:	68 9f 13 80 00       	push   $0x80139f
  800d84:	6a 23                	push   $0x23
  800d86:	68 bc 13 80 00       	push   $0x8013bc
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d9e:	e8 be fd ff ff       	call   800b61 <sys_getenvid>
  800da3:	83 ec 0c             	sub    $0xc,%esp
  800da6:	ff 75 0c             	pushl  0xc(%ebp)
  800da9:	ff 75 08             	pushl  0x8(%ebp)
  800dac:	56                   	push   %esi
  800dad:	50                   	push   %eax
  800dae:	68 cc 13 80 00       	push   $0x8013cc
  800db3:	e8 cf f3 ff ff       	call   800187 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800db8:	83 c4 18             	add    $0x18,%esp
  800dbb:	53                   	push   %ebx
  800dbc:	ff 75 10             	pushl  0x10(%ebp)
  800dbf:	e8 72 f3 ff ff       	call   800136 <vcprintf>
	cprintf("\n");
  800dc4:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  800dcb:	e8 b7 f3 ff ff       	call   800187 <cprintf>
