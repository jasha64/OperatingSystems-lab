...
00800238 <vprintfmt>:
{
  ...
  800284:	ff 24 85 40 11 80 00 	jmp    *0x801140(,%eax,4)
  ...
  800350:	8b 14 85 a0 12 80 00 	mov    0x8012a0(,%eax,4),%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800b04:	68 ff 12 80 00       	push   $0x8012ff
  800b09:	6a 23                	push   $0x23
  800b0b:	68 1c 13 80 00       	push   $0x80131c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b85:	68 ff 12 80 00       	push   $0x8012ff
  800b8a:	6a 23                	push   $0x23
  800b8c:	68 1c 13 80 00       	push   $0x80131c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bc7:	68 ff 12 80 00       	push   $0x8012ff
  800bcc:	6a 23                	push   $0x23
  800bce:	68 1c 13 80 00       	push   $0x80131c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c09:	68 ff 12 80 00       	push   $0x8012ff
  800c0e:	6a 23                	push   $0x23
  800c10:	68 1c 13 80 00       	push   $0x80131c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c4b:	68 ff 12 80 00       	push   $0x8012ff
  800c50:	6a 23                	push   $0x23
  800c52:	68 1c 13 80 00       	push   $0x80131c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c8d:	68 ff 12 80 00       	push   $0x8012ff
  800c92:	6a 23                	push   $0x23
  800c94:	68 1c 13 80 00       	push   $0x80131c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ccf:	68 ff 12 80 00       	push   $0x8012ff
  800cd4:	6a 23                	push   $0x23
  800cd6:	68 1c 13 80 00       	push   $0x80131c
...
sys_ipc_recv(void *dstva)
{
  ...
  800d33:	68 ff 12 80 00       	push   $0x8012ff
  800d38:	6a 23                	push   $0x23
  800d3a:	68 1c 13 80 00       	push   $0x80131c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d60:	56                   	push   %esi
  800d61:	50                   	push   %eax
  800d62:	68 2c 13 80 00       	push   $0x80132c
  ...
  800d73:	e8 72 f3 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800d78:	c7 04 24 fc 0f 80 00 	movl   $0x800ffc,(%esp)
