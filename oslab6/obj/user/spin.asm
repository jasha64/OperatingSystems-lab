...
umain(int argc, char **argv)
{
  ...
  80003f:	e8 5e 01 00 00       	call   8001a2 <cprintf>
	if ((env = fork()) == 0) {
  800044:	e8 32 0e 00 00       	call   800e7b <fork>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800205:	e8 26 0f 00 00       	call   801130 <__udivdi3>
  ...
  800243:	e8 08 10 00 00       	call   801250 <__umoddi3>
  800248:	83 c4 14             	add    $0x14,%esp
  80024b:	0f be 80 20 14 80 00 	movsbl 0x801420(%eax),%eax
  800252:	50                   	push   %eax
...
0080029f <vprintfmt>:
{
  ...
  8002eb:	ff 24 85 60 15 80 00 	jmp    *0x801560(,%eax,4)
  ...
  8003b7:	8b 14 85 c0 16 80 00 	mov    0x8016c0(,%eax,4),%edx
  8003be:	85 d2                	test   %edx,%edx
  8003c0:	74 18                	je     8003da <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  8003c2:	52                   	push   %edx
  8003c3:	68 41 14 80 00       	push   $0x801441
  8003c8:	53                   	push   %ebx
  8003c9:	56                   	push   %esi
  ...
  8003da:	50                   	push   %eax
  8003db:	68 38 14 80 00       	push   $0x801438
  8003e0:	53                   	push   %ebx
  8003e1:	56                   	push   %esi
  ...
  800402:	b8 31 14 80 00       	mov    $0x801431,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b6b:	68 1f 17 80 00       	push   $0x80171f
  800b70:	6a 23                	push   $0x23
  800b72:	68 3c 17 80 00       	push   $0x80173c
  800b77:	e8 eb 04 00 00       	call   801067 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bec:	68 1f 17 80 00       	push   $0x80171f
  800bf1:	6a 23                	push   $0x23
  800bf3:	68 3c 17 80 00       	push   $0x80173c
  800bf8:	e8 6a 04 00 00       	call   801067 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c2e:	68 1f 17 80 00       	push   $0x80171f
  800c33:	6a 23                	push   $0x23
  800c35:	68 3c 17 80 00       	push   $0x80173c
  800c3a:	e8 28 04 00 00       	call   801067 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c70:	68 1f 17 80 00       	push   $0x80171f
  800c75:	6a 23                	push   $0x23
  800c77:	68 3c 17 80 00       	push   $0x80173c
  800c7c:	e8 e6 03 00 00       	call   801067 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cb2:	68 1f 17 80 00       	push   $0x80171f
  800cb7:	6a 23                	push   $0x23
  800cb9:	68 3c 17 80 00       	push   $0x80173c
  800cbe:	e8 a4 03 00 00       	call   801067 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800ce4:	7f 08                	jg     800cee <sys_env_set_trapframe+0x2b>
  ...
  800cf4:	68 1f 17 80 00       	push   $0x80171f
  800cf9:	6a 23                	push   $0x23
  800cfb:	68 3c 17 80 00       	push   $0x80173c
  800d00:	e8 62 03 00 00       	call   801067 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d26:	7f 08                	jg     800d30 <sys_env_set_pgfault_upcall+0x2b>
  ...
  800d36:	68 1f 17 80 00       	push   $0x80171f
  800d3b:	6a 23                	push   $0x23
  800d3d:	68 3c 17 80 00       	push   $0x80173c
  800d42:	e8 20 03 00 00       	call   801067 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800d58:	be 00 00 00 00       	mov    $0x0,%esi
...
sys_ipc_recv(void *dstva)
{
  ...
  800d8a:	7f 08                	jg     800d94 <sys_ipc_recv+0x2a>
  ...
  800d9a:	68 1f 17 80 00       	push   $0x80171f
  800d9f:	6a 23                	push   $0x23
  800da1:	68 3c 17 80 00       	push   $0x80173c
  800da6:	e8 bc 02 00 00       	call   801067 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800db7:	f6 40 04 02          	testb  $0x2,0x4(%eax)
  800dbb:	74 74                	je     800e31 <pgfault+0x86>
  800dbd:	89 d8                	mov    %ebx,%eax
  800dbf:	c1 e8 0c             	shr    $0xc,%eax
  800dc2:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  800dc9:	f6 c4 08             	test   $0x8,%ah
  800dcc:	74 63                	je     800e31 <pgfault+0x86>
  ...
  800df7:	e8 be fd ff ff       	call   800bba <sys_page_alloc>
  800dfc:	83 c4 10             	add    $0x10,%esp
  800dff:	85 c0                	test   %eax,%eax
  800e01:	78 54                	js     800e57 <pgfault+0xac>
		panic("sys_page_alloc: %e", r);
	memmove(addr, PFTEMP, PGSIZE);								//将PFTEMP指向的物理页拷贝到addr指向的物理页
  800e03:	83 ec 04             	sub    $0x4,%esp
  800e06:	68 00 10 00 00       	push   $0x1000
  800e0b:	68 00 f0 7f 00       	push   $0x7ff000
  800e10:	53                   	push   %ebx
  800e11:	e8 39 fb ff ff       	call   80094f <memmove>
	if ((r = sys_page_unmap(0, PFTEMP)) < 0)					//解除当前进程PFTEMP映射
  800e16:	83 c4 08             	add    $0x8,%esp
  800e19:	68 00 f0 7f 00       	push   $0x7ff000
  800e1e:	6a 00                	push   $0x0
  800e20:	e8 1a fe ff ff       	call   800c3f <sys_page_unmap>
  800e25:	83 c4 10             	add    $0x10,%esp
  800e28:	85 c0                	test   %eax,%eax
  800e2a:	78 3d                	js     800e69 <pgfault+0xbe>
  ...
  800e34:	68 4a 17 80 00       	push   $0x80174a
  800e39:	6a 1d                	push   $0x1d
  800e3b:	68 5c 17 80 00       	push   $0x80175c
  800e40:	e8 22 02 00 00       	call   801067 <_panic>
		panic("sys_page_map: %e", r);
  800e45:	50                   	push   %eax
  800e46:	68 67 17 80 00       	push   $0x801767
  800e4b:	6a 2a                	push   $0x2a
  800e4d:	68 5c 17 80 00       	push   $0x80175c
  800e52:	e8 10 02 00 00       	call   801067 <_panic>
		panic("sys_page_alloc: %e", r);
  800e57:	50                   	push   %eax
  800e58:	68 78 17 80 00       	push   $0x801778
  800e5d:	6a 2c                	push   $0x2c
  800e5f:	68 5c 17 80 00       	push   $0x80175c
  800e64:	e8 fe 01 00 00       	call   801067 <_panic>
		panic("sys_page_unmap: %e", r);
  800e69:	50                   	push   %eax
  800e6a:	68 8b 17 80 00       	push   $0x80178b
  800e6f:	6a 2f                	push   $0x2f
  800e71:	68 5c 17 80 00       	push   $0x80175c
  800e76:	e8 ec 01 00 00       	call   801067 <_panic>
...
fork(void)
{
  ...
  800e84:	68 ab 0d 80 00       	push   $0x800dab
  800e89:	e8 1f 02 00 00       	call   8010ad <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800e9d:	74 12                	je     800eb1 <fork+0x36>
  ...
  800ea5:	78 26                	js     800ecd <fork+0x52>
  ...
  800eac:	e9 94 00 00 00       	jmp    800f45 <fork+0xca>
		thisenv = &envs[ENVX(sys_getenvid())];
  800eb1:	e8 c6 fc ff ff       	call   800b7c <sys_getenvid>
  800eb6:	25 ff 03 00 00       	and    $0x3ff,%eax
  800ebb:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800ebe:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800ec3:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
  800ec8:	e9 51 01 00 00       	jmp    80101e <fork+0x1a3>
		panic("sys_exofork: %e", envid);
  800ecd:	ff 75 e4             	pushl  -0x1c(%ebp)
  800ed0:	68 9e 17 80 00       	push   $0x80179e
  800ed5:	6a 6d                	push   $0x6d
  800ed7:	68 5c 17 80 00       	push   $0x80175c
  800edc:	e8 86 01 00 00       	call   801067 <_panic>
  ...
  800eee:	e8 0a fd ff ff       	call   800bfd <sys_page_map>
  800ef3:	83 c4 20             	add    $0x20,%esp
  800ef6:	eb 3b                	jmp    800f33 <fork+0xb8>
  ...
  800f05:	e8 f3 fc ff ff       	call   800bfd <sys_page_map>
  800f0a:	83 c4 20             	add    $0x20,%esp
  800f0d:	85 c0                	test   %eax,%eax
  800f0f:	0f 88 a9 00 00 00    	js     800fbe <fork+0x143>
  ...
  800f23:	e8 d5 fc ff ff       	call   800bfd <sys_page_map>
  800f28:	83 c4 20             	add    $0x20,%esp
  800f2b:	85 c0                	test   %eax,%eax
  800f2d:	0f 88 9d 00 00 00    	js     800fd0 <fork+0x155>
	for (addr = 0; addr < USTACKTOP; addr += PGSIZE) {
  800f33:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  800f39:	81 fb 00 e0 bf ee    	cmp    $0xeebfe000,%ebx
  800f3f:	0f 84 9d 00 00 00    	je     800fe2 <fork+0x167>
  ...
  800f53:	74 de                	je     800f33 <fork+0xb8>
  ...
  800f64:	74 cd                	je     800f33 <fork+0xb8>
			&& (uvpt[PGNUM(addr)] & PTE_U)) {
  800f66:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800f6d:	f6 c2 04             	test   $0x4,%dl
  800f70:	74 c1                	je     800f33 <fork+0xb8>
	void *addr = (void*) (pn * PGSIZE);
  800f72:	89 c6                	mov    %eax,%esi
  800f74:	c1 e6 0c             	shl    $0xc,%esi
	if (uvpt[pn] & PTE_SHARE) {
  800f77:	8b 14 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%edx
  800f7e:	f6 c6 04             	test   $0x4,%dh
  800f81:	0f 85 5a ff ff ff    	jne    800ee1 <fork+0x66>
  ...
  800f8e:	f6 c2 02             	test   $0x2,%dl
  800f91:	0f 85 61 ff ff ff    	jne    800ef8 <fork+0x7d>
  800f97:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  800f9e:	f6 c4 08             	test   $0x8,%ah
  800fa1:	0f 85 51 ff ff ff    	jne    800ef8 <fork+0x7d>
  ...
  800fb1:	e8 47 fc ff ff       	call   800bfd <sys_page_map>
  800fb6:	83 c4 20             	add    $0x20,%esp
  800fb9:	e9 75 ff ff ff       	jmp    800f33 <fork+0xb8>
			panic("sys_page_map：%e", r);
  800fbe:	50                   	push   %eax
  800fbf:	68 ae 17 80 00       	push   $0x8017ae
  800fc4:	6a 48                	push   $0x48
  800fc6:	68 5c 17 80 00       	push   $0x80175c
  800fcb:	e8 97 00 00 00       	call   801067 <_panic>
			panic("sys_page_map：%e", r);
  800fd0:	50                   	push   %eax
  800fd1:	68 ae 17 80 00       	push   $0x8017ae
  800fd6:	6a 4a                	push   $0x4a
  800fd8:	68 5c 17 80 00       	push   $0x80175c
  800fdd:	e8 85 00 00 00       	call   801067 <_panic>
  ...
  801028:	c3                   	ret    
		panic("sys_page_alloc: %e", r);
  801029:	50                   	push   %eax
  80102a:	68 78 17 80 00       	push   $0x801778
  80102f:	6a 79                	push   $0x79
  801031:	68 5c 17 80 00       	push   $0x80175c
  801036:	e8 2c 00 00 00       	call   801067 <_panic>
		panic("sys_env_set_status: %e", r);
  80103b:	50                   	push   %eax
  80103c:	68 c0 17 80 00       	push   $0x8017c0
  801041:	6a 7d                	push   $0x7d
  801043:	68 5c 17 80 00       	push   $0x80175c
  801048:	e8 1a 00 00 00       	call   801067 <_panic>
...
sfork(void)
{
  ...
  801053:	68 d7 17 80 00       	push   $0x8017d7
  801058:	68 85 00 00 00       	push   $0x85
  80105d:	68 5c 17 80 00       	push   $0x80175c
  801062:	e8 00 00 00 00       	call   801067 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80106f:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801075:	e8 02 fb ff ff       	call   800b7c <sys_getenvid>
  ...
  80108a:	e8 13 f1 ff ff       	call   8001a2 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80108f:	83 c4 18             	add    $0x18,%esp
  801092:	53                   	push   %ebx
  801093:	ff 75 10             	pushl  0x10(%ebp)
  801096:	e8 b6 f0 ff ff       	call   800151 <vcprintf>
	cprintf("\n");
  80109b:	c7 04 24 14 14 80 00 	movl   $0x801414,(%esp)
  8010a2:	e8 fb f0 ff ff       	call   8001a2 <cprintf>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8010b3:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  8010ba:	74 0a                	je     8010c6 <set_pgfault_handler+0x19>
		}
  ...
  8010d2:	e8 e3 fa ff ff       	call   800bba <sys_page_alloc>
		if (r < 0) {
  8010d7:	83 c4 10             	add    $0x10,%esp
  8010da:	85 c0                	test   %eax,%eax
  8010dc:	78 14                	js     8010f2 <set_pgfault_handler+0x45>
		sys_env_set_pgfault_upcall(0, _pgfault_upcall);		//系统调用，设置进程的env_pgfault_upcall属性
  8010de:	83 ec 08             	sub    $0x8,%esp
  8010e1:	68 06 11 80 00       	push   $0x801106
  8010e6:	6a 00                	push   $0x0
  8010e8:	e8 18 fc ff ff       	call   800d05 <sys_env_set_pgfault_upcall>
  8010ed:	83 c4 10             	add    $0x10,%esp
  8010f0:	eb ca                	jmp    8010bc <set_pgfault_handler+0xf>
			panic("set_pgfault_handler:sys_page_alloc failed");;
  8010f2:	83 ec 04             	sub    $0x4,%esp
  8010f5:	68 14 18 80 00       	push   $0x801814
  8010fa:	6a 22                	push   $0x22
  8010fc:	68 40 18 80 00       	push   $0x801840
  801101:	e8 61 ff ff ff       	call   801067 <_panic>

00801106 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  801114:	8b 44 24 28          	mov    0x28(%esp),%eax
	movl 32(%esp), %ecx 	//保存终端发生时的eip到ecx
  801118:	8b 4c 24 20          	mov    0x20(%esp),%ecx
	movl %ecx, -4(%eax) 	//将中断发生时的esp值亚入到到原来的栈中
  80111c:	89 48 fc             	mov    %ecx,-0x4(%eax)
	popal
  80111f:	61                   	popa   
	addl $4, %esp			//跳过eip
  ...
  801125:	8d 64 24 fc          	lea    -0x4(%esp),%esp
  801129:	c3                   	ret    
