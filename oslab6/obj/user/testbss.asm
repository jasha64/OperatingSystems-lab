	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002b8:	0f be 80 4b 11 80 00 	movsbl 0x80114b(%eax),%eax
  8002bf:	50                   	push   %eax
...
0080030c <vprintfmt>:
{
  ...
  800358:	ff 24 85 a0 12 80 00 	jmp    *0x8012a0(,%eax,4)
  ...
  80042f:	52                   	push   %edx
  800430:	68 6c 11 80 00       	push   $0x80116c
  800435:	53                   	push   %ebx
  800436:	56                   	push   %esi
  ...
  800447:	50                   	push   %eax
  800448:	68 63 11 80 00       	push   $0x801163
  80044d:	53                   	push   %ebx
  80044e:	56                   	push   %esi
  ...
  80046f:	b8 5c 11 80 00       	mov    $0x80115c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bd8:	68 60 14 80 00       	push   $0x801460
  800bdd:	6a 23                	push   $0x23
  800bdf:	68 7d 14 80 00       	push   $0x80147d
...
sys_yield(void)
{
  ...
  800c13:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c59:	68 60 14 80 00       	push   $0x801460
  800c5e:	6a 23                	push   $0x23
  800c60:	68 7d 14 80 00       	push   $0x80147d
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c9b:	68 60 14 80 00       	push   $0x801460
  800ca0:	6a 23                	push   $0x23
  800ca2:	68 7d 14 80 00       	push   $0x80147d
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cdd:	68 60 14 80 00       	push   $0x801460
  800ce2:	6a 23                	push   $0x23
  800ce4:	68 7d 14 80 00       	push   $0x80147d
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d1f:	68 60 14 80 00       	push   $0x801460
  800d24:	6a 23                	push   $0x23
  800d26:	68 7d 14 80 00       	push   $0x80147d
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d51:	7f 08                	jg     800d5b <sys_env_set_trapframe+0x2b>
  ...
  800d61:	68 60 14 80 00       	push   $0x801460
  800d66:	6a 23                	push   $0x23
  800d68:	68 7d 14 80 00       	push   $0x80147d
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d93:	7f 08                	jg     800d9d <sys_env_set_pgfault_upcall+0x2b>
  ...
  800da3:	68 60 14 80 00       	push   $0x801460
  800da8:	6a 23                	push   $0x23
  800daa:	68 7d 14 80 00       	push   $0x80147d
  800daf:	e8 80 f3 ff ff       	call   800134 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800df7:	7f 08                	jg     800e01 <sys_ipc_recv+0x2a>
  ...
  800e07:	68 60 14 80 00       	push   $0x801460
  800e0c:	6a 23                	push   $0x23
  800e0e:	68 7d 14 80 00       	push   $0x80147d
  800e13:	e8 1c f3 ff ff       	call   800134 <_panic>
