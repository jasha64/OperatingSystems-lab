...
umain(int argc, char **argv)
{
  ...
  80009c:	e8 50 0d 00 00       	call   800df1 <set_pgfault_handler>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800291:	0f be 80 5b 11 80 00 	movsbl 0x80115b(%eax),%eax
  800298:	50                   	push   %eax
...
008002e5 <vprintfmt>:
{
  ...
  800331:	ff 24 85 a0 12 80 00 	jmp    *0x8012a0(,%eax,4)
  ...
  8003fd:	8b 14 85 00 14 80 00 	mov    0x801400(,%eax,4),%edx
  800404:	85 d2                	test   %edx,%edx
  800406:	74 18                	je     800420 <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  800408:	52                   	push   %edx
  800409:	68 7c 11 80 00       	push   $0x80117c
  80040e:	53                   	push   %ebx
  80040f:	56                   	push   %esi
  ...
  800420:	50                   	push   %eax
  800421:	68 73 11 80 00       	push   $0x801173
  800426:	53                   	push   %ebx
  800427:	56                   	push   %esi
  ...
  800448:	b8 6c 11 80 00       	mov    $0x80116c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bb1:	68 5f 14 80 00       	push   $0x80145f
  800bb6:	6a 23                	push   $0x23
  800bb8:	68 7c 14 80 00       	push   $0x80147c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c32:	68 5f 14 80 00       	push   $0x80145f
  800c37:	6a 23                	push   $0x23
  800c39:	68 7c 14 80 00       	push   $0x80147c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c74:	68 5f 14 80 00       	push   $0x80145f
  800c79:	6a 23                	push   $0x23
  800c7b:	68 7c 14 80 00       	push   $0x80147c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb6:	68 5f 14 80 00       	push   $0x80145f
  800cbb:	6a 23                	push   $0x23
  800cbd:	68 7c 14 80 00       	push   $0x80147c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cf8:	68 5f 14 80 00       	push   $0x80145f
  800cfd:	6a 23                	push   $0x23
  800cff:	68 7c 14 80 00       	push   $0x80147c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d2a:	7f 08                	jg     800d34 <sys_env_set_trapframe+0x2b>
  ...
  800d3a:	68 5f 14 80 00       	push   $0x80145f
  800d3f:	6a 23                	push   $0x23
  800d41:	68 7c 14 80 00       	push   $0x80147c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d6c:	7f 08                	jg     800d76 <sys_env_set_pgfault_upcall+0x2b>
  ...
  800d7c:	68 5f 14 80 00       	push   $0x80145f
  800d81:	6a 23                	push   $0x23
  800d83:	68 7c 14 80 00       	push   $0x80147c
  800d88:	e8 80 f3 ff ff       	call   80010d <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800dd0:	7f 08                	jg     800dda <sys_ipc_recv+0x2a>
  ...
  800de0:	68 5f 14 80 00       	push   $0x80145f
  800de5:	6a 23                	push   $0x23
  800de7:	68 7c 14 80 00       	push   $0x80147c
  800dec:	e8 1c f3 ff ff       	call   80010d <_panic>

00800df1 <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800df7:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800dfe:	74 0a                	je     800e0a <set_pgfault_handler+0x19>
		}
  ...
  800e03:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800e08:	c9                   	leave  
  800e09:	c3                   	ret    
  ...
  800e16:	e8 e5 fd ff ff       	call   800c00 <sys_page_alloc>
		if (r < 0) {
  800e1b:	83 c4 10             	add    $0x10,%esp
  800e1e:	85 c0                	test   %eax,%eax
  800e20:	78 14                	js     800e36 <set_pgfault_handler+0x45>
		sys_env_set_pgfault_upcall(0, _pgfault_upcall);		//系统调用，设置进程的env_pgfault_upcall属性
  800e22:	83 ec 08             	sub    $0x8,%esp
  800e25:	68 4a 0e 80 00       	push   $0x800e4a
  800e2a:	6a 00                	push   $0x0
  800e2c:	e8 1a ff ff ff       	call   800d4b <sys_env_set_pgfault_upcall>
  800e31:	83 c4 10             	add    $0x10,%esp
  800e34:	eb ca                	jmp    800e00 <set_pgfault_handler+0xf>
			panic("set_pgfault_handler:sys_page_alloc failed");;
  800e36:	83 ec 04             	sub    $0x4,%esp
  800e39:	68 8c 14 80 00       	push   $0x80148c
  800e3e:	6a 22                	push   $0x22
  800e40:	68 b8 14 80 00       	push   $0x8014b8
  800e45:	e8 c3 f2 ff ff       	call   80010d <_panic>
...
_pgfault_upcall:
  ...
  800e58:	8b 44 24 28          	mov    0x28(%esp),%eax
	movl 32(%esp), %ecx 	//保存终端发生时的eip到ecx
  800e5c:	8b 4c 24 20          	mov    0x20(%esp),%ecx
	movl %ecx, -4(%eax) 	//将中断发生时的esp值亚入到到原来的栈中
  800e60:	89 48 fc             	mov    %ecx,-0x4(%eax)
	popal
  800e63:	61                   	popa   
	addl $4, %esp			//跳过eip
  ...
  800e69:	8d 64 24 fc          	lea    -0x4(%esp),%esp
  800e6d:	c3                   	ret    
