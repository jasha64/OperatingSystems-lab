...
duppage(envid_t dstenv, void *addr)
{
  ...
  80009a:	c3                   	ret    
		panic("sys_page_alloc: %e", r);
  80009b:	50                   	push   %eax
  80009c:	68 60 11 80 00       	push   $0x801160
  8000a1:	6a 20                	push   $0x20
  8000a3:	68 73 11 80 00       	push   $0x801173
  8000a8:	e8 7f 01 00 00       	call   80022c <_panic>
		panic("sys_page_map: %e", r);				//效果是使当前环境UTEMP指向和dstenv环境addr相同的内存处
  8000ad:	50                   	push   %eax
  8000ae:	68 83 11 80 00       	push   $0x801183
  8000b3:	6a 22                	push   $0x22
  8000b5:	68 73 11 80 00       	push   $0x801173
  8000ba:	e8 6d 01 00 00       	call   80022c <_panic>
		panic("sys_page_unmap: %e", r);
  8000bf:	50                   	push   %eax
  8000c0:	68 94 11 80 00       	push   $0x801194
  8000c5:	6a 25                	push   $0x25
  8000c7:	68 73 11 80 00       	push   $0x801173
...
sys_exofork(void)
{
  ...
  8000f3:	eb 3f                	jmp    800134 <dumbfork+0x63>
		panic("sys_exofork: %e", envid);
  8000f5:	50                   	push   %eax
  8000f6:	68 a7 11 80 00       	push   $0x8011a7
  8000fb:	6a 37                	push   $0x37
  8000fd:	68 73 11 80 00       	push   $0x801173
  ...
  80016b:	c3                   	ret    
		panic("sys_env_set_status: %e", r);
  80016c:	50                   	push   %eax
  80016d:	68 b7 11 80 00       	push   $0x8011b7
  800172:	6a 4c                	push   $0x4c
  800174:	68 73 11 80 00       	push   $0x801173
...
0080017e <umain>:
{
  ...
  800190:	be ce 11 80 00       	mov    $0x8011ce,%esi
  800195:	b8 d5 11 80 00       	mov    $0x8011d5,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800248:	56                   	push   %esi
  800249:	50                   	push   %eax
  80024a:	68 f8 11 80 00       	push   $0x8011f8
  ...
  80025b:	e8 56 00 00 00       	call   8002b6 <vcprintf>
	cprintf("\n");
  800260:	c7 04 24 eb 11 80 00 	movl   $0x8011eb,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80036a:	e8 a1 0b 00 00       	call   800f10 <__udivdi3>
  ...
  8003a8:	e8 83 0c 00 00       	call   801030 <__umoddi3>
  8003ad:	83 c4 14             	add    $0x14,%esp
  8003b0:	0f be 80 1b 12 80 00 	movsbl 0x80121b(%eax),%eax
  8003b7:	50                   	push   %eax
...
00800404 <vprintfmt>:
{
  ...
  800450:	ff 24 85 60 13 80 00 	jmp    *0x801360(,%eax,4)
  ...
  80051c:	8b 14 85 c0 14 80 00 	mov    0x8014c0(,%eax,4),%edx
  800523:	85 d2                	test   %edx,%edx
  800525:	74 18                	je     80053f <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  800527:	52                   	push   %edx
  800528:	68 3c 12 80 00       	push   $0x80123c
  80052d:	53                   	push   %ebx
  80052e:	56                   	push   %esi
  ...
  80053f:	50                   	push   %eax
  800540:	68 33 12 80 00       	push   $0x801233
  800545:	53                   	push   %ebx
  800546:	56                   	push   %esi
  ...
  800567:	b8 2c 12 80 00       	mov    $0x80122c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800cd0:	68 20 15 80 00       	push   $0x801520
  800cd5:	6a 23                	push   $0x23
  800cd7:	68 3d 15 80 00       	push   $0x80153d
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d51:	68 20 15 80 00       	push   $0x801520
  800d56:	6a 23                	push   $0x23
  800d58:	68 3d 15 80 00       	push   $0x80153d
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d93:	68 20 15 80 00       	push   $0x801520
  800d98:	6a 23                	push   $0x23
  800d9a:	68 3d 15 80 00       	push   $0x80153d
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800dd5:	68 20 15 80 00       	push   $0x801520
  800dda:	6a 23                	push   $0x23
  800ddc:	68 3d 15 80 00       	push   $0x80153d
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e17:	68 20 15 80 00       	push   $0x801520
  800e1c:	6a 23                	push   $0x23
  800e1e:	68 3d 15 80 00       	push   $0x80153d
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e59:	68 20 15 80 00       	push   $0x801520
  800e5e:	6a 23                	push   $0x23
  800e60:	68 3d 15 80 00       	push   $0x80153d
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e9b:	68 20 15 80 00       	push   $0x801520
  800ea0:	6a 23                	push   $0x23
  800ea2:	68 3d 15 80 00       	push   $0x80153d
...
sys_ipc_recv(void *dstva)
{
  ...
  800eff:	68 20 15 80 00       	push   $0x801520
  800f04:	6a 23                	push   $0x23
  800f06:	68 3d 15 80 00       	push   $0x80153d
...
00800f10 <__udivdi3>:
  ...
  800f2d:	0f 87 bd 00 00 00    	ja     800ff0 <__udivdi3+0xe0>
  800f33:	85 db                	test   %ebx,%ebx
  800f35:	89 d9                	mov    %ebx,%ecx
  800f37:	75 0b                	jne    800f44 <__udivdi3+0x34>
  800f39:	b8 01 00 00 00       	mov    $0x1,%eax
  800f3e:	31 d2                	xor    %edx,%edx
  800f40:	f7 f3                	div    %ebx
  800f42:	89 c1                	mov    %eax,%ecx
  800f44:	31 d2                	xor    %edx,%edx
  800f46:	89 f0                	mov    %esi,%eax
  800f48:	f7 f1                	div    %ecx
  800f4a:	89 c6                	mov    %eax,%esi
  800f4c:	89 e8                	mov    %ebp,%eax
  800f4e:	89 f7                	mov    %esi,%edi
  ...
  800f62:	77 7c                	ja     800fe0 <__udivdi3+0xd0>
  800f64:	0f bd fa             	bsr    %edx,%edi
  800f67:	83 f7 1f             	xor    $0x1f,%edi
  800f6a:	0f 84 98 00 00 00    	je     801008 <__udivdi3+0xf8>
  ...
  800f9f:	d3 e6                	shl    %cl,%esi
  800fa1:	89 eb                	mov    %ebp,%ebx
  ...
  800fb9:	72 0c                	jb     800fc7 <__udivdi3+0xb7>
  800fbb:	89 f9                	mov    %edi,%ecx
  800fbd:	d3 e5                	shl    %cl,%ebp
  800fbf:	39 c5                	cmp    %eax,%ebp
  800fc1:	73 5d                	jae    801020 <__udivdi3+0x110>
  800fc3:	39 d6                	cmp    %edx,%esi
  800fc5:	75 59                	jne    801020 <__udivdi3+0x110>
  800fc7:	8d 43 ff             	lea    -0x1(%ebx),%eax
  800fca:	31 ff                	xor    %edi,%edi
  ...
  800fd4:	5d                   	pop    %ebp
  800fd5:	c3                   	ret    
  800fd6:	8d 76 00             	lea    0x0(%esi),%esi
  800fd9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  800fe0:	31 ff                	xor    %edi,%edi
  800fe2:	31 c0                	xor    %eax,%eax
  800fe4:	89 fa                	mov    %edi,%edx
  800fe6:	83 c4 1c             	add    $0x1c,%esp
  800fe9:	5b                   	pop    %ebx
  800fea:	5e                   	pop    %esi
  800feb:	5f                   	pop    %edi
  800fec:	5d                   	pop    %ebp
  ...
  800ff2:	89 e8                	mov    %ebp,%eax
  800ff4:	89 f2                	mov    %esi,%edx
  800ff6:	f7 f3                	div    %ebx
  ...
  80100a:	72 06                	jb     801012 <__udivdi3+0x102>
  80100c:	31 c0                	xor    %eax,%eax
  80100e:	39 eb                	cmp    %ebp,%ebx
  801010:	77 d2                	ja     800fe4 <__udivdi3+0xd4>
  801012:	b8 01 00 00 00       	mov    $0x1,%eax
  801017:	eb cb                	jmp    800fe4 <__udivdi3+0xd4>
  801019:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  801020:	89 d8                	mov    %ebx,%eax
  801022:	31 ff                	xor    %edi,%edi
  801024:	eb be                	jmp    800fe4 <__udivdi3+0xd4>
...
00801030 <__umoddi3>:
  ...
  801037:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  80103b:	8b 74 24 30          	mov    0x30(%esp),%esi
  80103f:	8b 5c 24 34          	mov    0x34(%esp),%ebx
  801043:	8b 7c 24 38          	mov    0x38(%esp),%edi
  801047:	85 ed                	test   %ebp,%ebp
  801049:	89 f0                	mov    %esi,%eax
  80104b:	89 da                	mov    %ebx,%edx
  80104d:	75 19                	jne    801068 <__umoddi3+0x38>
  80104f:	39 df                	cmp    %ebx,%edi
  801051:	0f 86 b1 00 00 00    	jbe    801108 <__umoddi3+0xd8>
  ...
  801068:	39 dd                	cmp    %ebx,%ebp
  80106a:	77 f1                	ja     80105d <__umoddi3+0x2d>
  80106c:	0f bd cd             	bsr    %ebp,%ecx
  80106f:	83 f1 1f             	xor    $0x1f,%ecx
  801072:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  801076:	0f 84 b4 00 00 00    	je     801130 <__umoddi3+0x100>
  80107c:	b8 20 00 00 00       	mov    $0x20,%eax
  801081:	89 c2                	mov    %eax,%edx
  801083:	8b 44 24 04          	mov    0x4(%esp),%eax
  ...
  801097:	09 c5                	or     %eax,%ebp
  801099:	8b 44 24 04          	mov    0x4(%esp),%eax
  80109d:	89 c1                	mov    %eax,%ecx
  80109f:	d3 e7                	shl    %cl,%edi
  8010a1:	89 d1                	mov    %edx,%ecx
  8010a3:	89 7c 24 08          	mov    %edi,0x8(%esp)
  8010a7:	89 df                	mov    %ebx,%edi
  8010a9:	d3 ef                	shr    %cl,%edi
  8010ab:	89 c1                	mov    %eax,%ecx
  8010ad:	89 f0                	mov    %esi,%eax
  8010af:	d3 e3                	shl    %cl,%ebx
  8010b1:	89 d1                	mov    %edx,%ecx
  8010b3:	89 fa                	mov    %edi,%edx
  8010b5:	d3 e8                	shr    %cl,%eax
  8010b7:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  8010bc:	09 d8                	or     %ebx,%eax
  8010be:	f7 f5                	div    %ebp
  8010c0:	d3 e6                	shl    %cl,%esi
  8010c2:	89 d1                	mov    %edx,%ecx
  8010c4:	f7 64 24 08          	mull   0x8(%esp)
  8010c8:	39 d1                	cmp    %edx,%ecx
  8010ca:	89 c3                	mov    %eax,%ebx
  8010cc:	89 d7                	mov    %edx,%edi
  8010ce:	72 06                	jb     8010d6 <__umoddi3+0xa6>
  8010d0:	75 0e                	jne    8010e0 <__umoddi3+0xb0>
  8010d2:	39 c6                	cmp    %eax,%esi
  8010d4:	73 0a                	jae    8010e0 <__umoddi3+0xb0>
  8010d6:	2b 44 24 08          	sub    0x8(%esp),%eax
  8010da:	19 ea                	sbb    %ebp,%edx
  8010dc:	89 d7                	mov    %edx,%edi
  8010de:	89 c3                	mov    %eax,%ebx
  8010e0:	89 ca                	mov    %ecx,%edx
  8010e2:	0f b6 4c 24 0c       	movzbl 0xc(%esp),%ecx
  8010e7:	29 de                	sub    %ebx,%esi
  8010e9:	19 fa                	sbb    %edi,%edx
  8010eb:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  8010ef:	89 d0                	mov    %edx,%eax
  8010f1:	d3 e0                	shl    %cl,%eax
  8010f3:	89 d9                	mov    %ebx,%ecx
  8010f5:	d3 ee                	shr    %cl,%esi
  8010f7:	d3 ea                	shr    %cl,%edx
  8010f9:	09 f0                	or     %esi,%eax
  8010fb:	83 c4 1c             	add    $0x1c,%esp
  8010fe:	5b                   	pop    %ebx
  8010ff:	5e                   	pop    %esi
  801100:	5f                   	pop    %edi
  801101:	5d                   	pop    %ebp
  ...
  80110c:	75 0b                	jne    801119 <__umoddi3+0xe9>
  ...
  801121:	f7 f1                	div    %ecx
  801123:	e9 31 ff ff ff       	jmp    801059 <__umoddi3+0x29>
  801128:	90                   	nop
  801129:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  801130:	39 dd                	cmp    %ebx,%ebp
  801132:	72 08                	jb     80113c <__umoddi3+0x10c>
  801134:	39 f7                	cmp    %esi,%edi
  801136:	0f 87 21 ff ff ff    	ja     80105d <__umoddi3+0x2d>
  80113c:	89 da                	mov    %ebx,%edx
  80113e:	89 f0                	mov    %esi,%eax
  801140:	29 f8                	sub    %edi,%eax
  801142:	19 ea                	sbb    %ebp,%edx
  801144:	e9 14 ff ff ff       	jmp    80105d <__umoddi3+0x2d>
