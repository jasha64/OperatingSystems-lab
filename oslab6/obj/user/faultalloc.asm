...
handler(struct UTrapframe *utf)
{
  ...
  800065:	53                   	push   %ebx
  800066:	68 2c 11 80 00       	push   $0x80112c
  ...
  80007e:	50                   	push   %eax
  80007f:	53                   	push   %ebx
  800080:	68 00 11 80 00       	push   $0x801100
  800085:	6a 0e                	push   $0xe
  800087:	68 ea 10 80 00       	push   $0x8010ea
...
umain(int argc, char **argv)
{
  ...
  80009c:	e8 65 0d 00 00       	call   800e06 <set_pgfault_handler>
	cprintf("%s\n", (char*)0xDeadBeef);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800151:	e8 56 00 00 00       	call   8001ac <vcprintf>
	cprintf("\n");
  800156:	c7 04 24 fe 10 80 00 	movl   $0x8010fe,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800260:	e8 2b 0c 00 00       	call   800e90 <__udivdi3>
  ...
  80029e:	e8 0d 0d 00 00       	call   800fb0 <__umoddi3>
  8002a3:	83 c4 14             	add    $0x14,%esp
  8002a6:	0f be 80 7b 11 80 00 	movsbl 0x80117b(%eax),%eax
  8002ad:	50                   	push   %eax
...
008002fa <vprintfmt>:
{
  ...
  800346:	ff 24 85 c0 12 80 00 	jmp    *0x8012c0(,%eax,4)
  ...
  800412:	8b 14 85 20 14 80 00 	mov    0x801420(,%eax,4),%edx
  800419:	85 d2                	test   %edx,%edx
  80041b:	74 18                	je     800435 <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  80041d:	52                   	push   %edx
  80041e:	68 9c 11 80 00       	push   $0x80119c
  800423:	53                   	push   %ebx
  800424:	56                   	push   %esi
  ...
  800435:	50                   	push   %eax
  800436:	68 93 11 80 00       	push   $0x801193
  80043b:	53                   	push   %ebx
  80043c:	56                   	push   %esi
  ...
  80045d:	b8 8c 11 80 00       	mov    $0x80118c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bc6:	68 7f 14 80 00       	push   $0x80147f
  800bcb:	6a 23                	push   $0x23
  800bcd:	68 9c 14 80 00       	push   $0x80149c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c47:	68 7f 14 80 00       	push   $0x80147f
  800c4c:	6a 23                	push   $0x23
  800c4e:	68 9c 14 80 00       	push   $0x80149c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c89:	68 7f 14 80 00       	push   $0x80147f
  800c8e:	6a 23                	push   $0x23
  800c90:	68 9c 14 80 00       	push   $0x80149c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ccb:	68 7f 14 80 00       	push   $0x80147f
  800cd0:	6a 23                	push   $0x23
  800cd2:	68 9c 14 80 00       	push   $0x80149c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d0d:	68 7f 14 80 00       	push   $0x80147f
  800d12:	6a 23                	push   $0x23
  800d14:	68 9c 14 80 00       	push   $0x80149c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d3f:	7f 08                	jg     800d49 <sys_env_set_trapframe+0x2b>
  ...
  800d4f:	68 7f 14 80 00       	push   $0x80147f
  800d54:	6a 23                	push   $0x23
  800d56:	68 9c 14 80 00       	push   $0x80149c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d81:	7f 08                	jg     800d8b <sys_env_set_pgfault_upcall+0x2b>
  ...
  800d91:	68 7f 14 80 00       	push   $0x80147f
  800d96:	6a 23                	push   $0x23
  800d98:	68 9c 14 80 00       	push   $0x80149c
  800d9d:	e8 80 f3 ff ff       	call   800122 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800de5:	7f 08                	jg     800def <sys_ipc_recv+0x2a>
  ...
  800df5:	68 7f 14 80 00       	push   $0x80147f
  800dfa:	6a 23                	push   $0x23
  800dfc:	68 9c 14 80 00       	push   $0x80149c
  800e01:	e8 1c f3 ff ff       	call   800122 <_panic>

00800e06 <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e0c:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800e13:	74 0a                	je     800e1f <set_pgfault_handler+0x19>
		}
  ...
  800e18:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800e1d:	c9                   	leave  
  800e1e:	c3                   	ret    
  ...
  800e2b:	e8 e5 fd ff ff       	call   800c15 <sys_page_alloc>
		if (r < 0) {
  800e30:	83 c4 10             	add    $0x10,%esp
  800e33:	85 c0                	test   %eax,%eax
  800e35:	78 14                	js     800e4b <set_pgfault_handler+0x45>
		sys_env_set_pgfault_upcall(0, _pgfault_upcall);		//系统调用，设置进程的env_pgfault_upcall属性
  800e37:	83 ec 08             	sub    $0x8,%esp
  800e3a:	68 5f 0e 80 00       	push   $0x800e5f
  800e3f:	6a 00                	push   $0x0
  800e41:	e8 1a ff ff ff       	call   800d60 <sys_env_set_pgfault_upcall>
  800e46:	83 c4 10             	add    $0x10,%esp
  800e49:	eb ca                	jmp    800e15 <set_pgfault_handler+0xf>
			panic("set_pgfault_handler:sys_page_alloc failed");;
  800e4b:	83 ec 04             	sub    $0x4,%esp
  800e4e:	68 ac 14 80 00       	push   $0x8014ac
  800e53:	6a 22                	push   $0x22
  800e55:	68 d8 14 80 00       	push   $0x8014d8
  800e5a:	e8 c3 f2 ff ff       	call   800122 <_panic>

00800e5f <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800e60:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax				//调用页处理函数
  ...
  800e6d:	8b 44 24 28          	mov    0x28(%esp),%eax
	movl 32(%esp), %ecx 	//保存终端发生时的eip到ecx
  800e71:	8b 4c 24 20          	mov    0x20(%esp),%ecx
	movl %ecx, -4(%eax) 	//将中断发生时的esp值亚入到到原来的栈中
  800e75:	89 48 fc             	mov    %ecx,-0x4(%eax)
	popal
  800e78:	61                   	popa   
	addl $4, %esp			//跳过eip
  ...
  800e7e:	8d 64 24 fc          	lea    -0x4(%esp),%esp
  800e82:	c3                   	ret    
