	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e4:	0f be 80 11 10 80 00 	movsbl 0x801011(%eax),%eax
  8001eb:	50                   	push   %eax
...
00800238 <vprintfmt>:
{
  ...
  800284:	ff 24 85 60 11 80 00 	jmp    *0x801160(,%eax,4)
  ...
  80034b:	83 f8 0f             	cmp    $0xf,%eax
  80034e:	7f 23                	jg     800373 <vprintfmt+0x13b>
  800350:	8b 14 85 c0 12 80 00 	mov    0x8012c0(,%eax,4),%edx
  800357:	85 d2                	test   %edx,%edx
  800359:	74 18                	je     800373 <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  80035b:	52                   	push   %edx
  80035c:	68 32 10 80 00       	push   $0x801032
  800361:	53                   	push   %ebx
  800362:	56                   	push   %esi
  ...
  800373:	50                   	push   %eax
  800374:	68 29 10 80 00       	push   $0x801029
  800379:	53                   	push   %ebx
  80037a:	56                   	push   %esi
  ...
  80039b:	b8 22 10 80 00       	mov    $0x801022,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b10:	e8 2f 02 00 00       	call   800d44 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b85:	68 1f 13 80 00       	push   $0x80131f
  800b8a:	6a 23                	push   $0x23
  800b8c:	68 3c 13 80 00       	push   $0x80133c
  800b91:	e8 ae 01 00 00       	call   800d44 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bc7:	68 1f 13 80 00       	push   $0x80131f
  800bcc:	6a 23                	push   $0x23
  800bce:	68 3c 13 80 00       	push   $0x80133c
  800bd3:	e8 6c 01 00 00       	call   800d44 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c09:	68 1f 13 80 00       	push   $0x80131f
  800c0e:	6a 23                	push   $0x23
  800c10:	68 3c 13 80 00       	push   $0x80133c
  800c15:	e8 2a 01 00 00       	call   800d44 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c4b:	68 1f 13 80 00       	push   $0x80131f
  800c50:	6a 23                	push   $0x23
  800c52:	68 3c 13 80 00       	push   $0x80133c
  800c57:	e8 e8 00 00 00       	call   800d44 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c7d:	7f 08                	jg     800c87 <sys_env_set_trapframe+0x2b>
  ...
  800c8d:	68 1f 13 80 00       	push   $0x80131f
  800c92:	6a 23                	push   $0x23
  800c94:	68 3c 13 80 00       	push   $0x80133c
  800c99:	e8 a6 00 00 00       	call   800d44 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cbf:	7f 08                	jg     800cc9 <sys_env_set_pgfault_upcall+0x2b>
  ...
  800ccf:	68 1f 13 80 00       	push   $0x80131f
  800cd4:	6a 23                	push   $0x23
  800cd6:	68 3c 13 80 00       	push   $0x80133c
  800cdb:	e8 64 00 00 00       	call   800d44 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d23:	7f 08                	jg     800d2d <sys_ipc_recv+0x2a>
  ...
  800d33:	68 1f 13 80 00       	push   $0x80131f
  800d38:	6a 23                	push   $0x23
  800d3a:	68 3c 13 80 00       	push   $0x80133c
  800d3f:	e8 00 00 00 00       	call   800d44 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d52:	e8 be fd ff ff       	call   800b15 <sys_getenvid>
  800d57:	83 ec 0c             	sub    $0xc,%esp
  800d5a:	ff 75 0c             	pushl  0xc(%ebp)
  800d5d:	ff 75 08             	pushl  0x8(%ebp)
  800d60:	56                   	push   %esi
  800d61:	50                   	push   %eax
  800d62:	68 4c 13 80 00       	push   $0x80134c
  800d67:	e8 cf f3 ff ff       	call   80013b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800d6c:	83 c4 18             	add    $0x18,%esp
  800d6f:	53                   	push   %ebx
  800d70:	ff 75 10             	pushl  0x10(%ebp)
  800d73:	e8 72 f3 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800d78:	c7 04 24 70 13 80 00 	movl   $0x801370,(%esp)
  800d7f:	e8 b7 f3 ff ff       	call   80013b <cprintf>
